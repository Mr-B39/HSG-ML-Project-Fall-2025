...
#####################################################################
# ===================== PART D: REPORT GRAPHS =======================
#####################################################################

##############################
# D0) LIBRARIES FOR REPORT
##############################
library(ggplot2)
library(scales)
...
##############################
# D2) GRAPH: PREDICTED VS ACTUAL (HOLDOUT)
##############################
...
##############################
# D3) GRAPH: RESIDUAL DISTRIBUTION
##############################
...
##############################
# D4) GRAPH: RESIDUALS VS PREDICTED
...
#####################################################################
# D5) FEATURE IMPORTANCE — SIMPLE & ROBUST (DIRECT ranger)
#####################################################################
...
#####################################################################
# D6) PARTIAL DEPENDENCE PLOTS (TOP 4 FEATURES) — using pdp + ranger
#####################################################################
